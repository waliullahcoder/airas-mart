                            ...
                            <div class="card">
                                <div class="card-header pe-2 py-2">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="h6 mb-0 text-uppercase"><?php echo e($title ?? 'Please Set Title'); ?></h6>

                                        <?php
                                            $routeName = \Request::route()->getName();
                                            $createRoute = str_replace('index', 'create', $routeName);
                                            $trashRoute = str_contains($routeName, '.index')
                                                ? str_replace('index', 'trash', $routeName)
                                                : str_replace('pending', 'trash', $routeName);
                                        ?>
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($trashRoute)): ?>
                                                <select id="filter" class="form-select trash_select flex-shrink-0">
                                                    <option value="all">All</option>
                                                    <option value="trash">Trash</option>
                                                </select>
                                            <?php endif; ?>

                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($createRoute)): ?>
                                                <?php if(empty($inactive_create)): ?>
                                                    <a href="<?php echo e(route($createRoute)); ?>" class="btn btn-primary btn-sm" id="addBtn">Add
                                                        New</a>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </div>
...
<?php /**PATH D:\laragon\www\airas-mart\resources\views/layouts/admin/index_app.blade.php ENDPATH**/ ?>